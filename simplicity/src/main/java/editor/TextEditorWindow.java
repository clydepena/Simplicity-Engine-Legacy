...
public class TextEditorWindow extends ImGuiInterface {
    ...
    public static void show() {
        ...
        ImGui.begin("Text Editor", ImGuiWindowFlags.HorizontalScrollbar | ImGuiWindowFlags.MenuBar);
        ...
        int col = EDITOR.getCursorPositionColumn();
        int line = EDITOR.getCursorPositionLine();

        String overwrite = EDITOR.isOverwrite() ? "Ovr" : "Ins";
        String canUndo = EDITOR.canUndo() ? "*" : " ";

        ImGui.text(line + "/" + col + " " + EDITOR.getTotalLines() + " lines | " + overwrite + " | " + canUndo);
    ...
    @Override
    public void destroy() {
        TextEditorWindow.EDITOR.destroy();
    }
}
*/